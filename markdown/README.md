...
# XgeneCloud : One command to generate REST-GraphQL APIs on MySql database with Code!

# Why this ?
<p align="center">
  <img src="../static/rick-and-morty.gif" alt="xmysql gif"/>
</p>
...
```
# generate rest apis
xc gen.apis.rest -u "mysql://localhost:3306?u=root&p=password&d=gm"

or 

# generate rest graphql
xc gen.apis.rest -u "mysql://localhost:3306?u=root&p=password&d=gm"
